...
<div class="records">
    ...
    <table>
        ...
        <tbody>
            ...
            if (isset($_POST['return_key']) && isset($_POST['borrower_id'])) {
            ...
            // Fetch records
            $sql = "SELECT borrower_id, borrower_section, key_name, borrow_date, return_date
                    FROM users
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    if (is_null($row['return_date'])) {
                        echo "<form method='POST' action=''>
                                ...
                                <button type='submit' name='return_key'>Return</button>
                              </form>";
                    }
                    echo "</td>
                          </tr>";
